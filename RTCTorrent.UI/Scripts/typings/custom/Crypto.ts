...
module RtcTorrent {
    ...
    export class Crypto implements ICrypto {
        public hexcase: number;
        public b64pad: string;
        public chrsz: number;
        constructor() {
        }

        //TODO: Clean this up and rename methods to camel-casing.

        hex_sha1(s) { return this.binb2hex(this.core_sha1(this.str2binb(s), s.length * this.chrsz)); }
        b64_sha1(s) { return this.binb2b64(this.core_sha1(this.str2binb(s), s.length * this.chrsz)); }
        str_sha1(s) { return this.binb2str(this.core_sha1(this.str2binb(s), s.length * this.chrsz)); }
        hex_hmac_sha1(key, data) { return this.binb2hex(this.core_hmac_sha1(key, data)); }
        b64_hmac_sha1(key, data) { return this.binb2b64(this.core_hmac_sha1(key, data)); }
        str_hmac_sha1(key, data) { return this.binb2str(this.core_hmac_sha1(key, data)); }
