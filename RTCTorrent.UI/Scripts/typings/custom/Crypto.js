...
(function (RtcTorrent) {
    ...
    var Crypto = (function () {
        ...
        Crypto.prototype.sha1_ft = function (t, b, c, d) {
            if(t < 20) {
                return (b & c) | ((~b) & d);
            }
            if(t < 40) {
        ...
        Crypto.prototype.sha1_kt = function (t) {
            return (t < 20) ? 1518500249 : (t < 40) ? 1859775393 : (t < 60) ? -1894007588 : -899497514;
        };
        Crypto.prototype.core_hmac_sha1 = function (key, data) {
        ...
        Crypto.prototype.safe_add = function (x, y) {
            var lsw = (x & 0xFFFF) + (y & 0xFFFF);
            var msw = (x >> 16) + (y >> 16) + (lsw >> 16);
            return (msw << 16) | (lsw & 0xFFFF);
        };
        Crypto.prototype.rol = function (num, cnt) {
            return (num << cnt) | (num >>> (32 - cnt));
        };
        Crypto.prototype.str2binb = function (str) {
            var bin = Array();
        ...
        Crypto.prototype.binb2str = function (bin) {
            var str = "";
            var mask = (1 << this.chrsz) - 1;
        ...
        Crypto.prototype.binb2hex = function (binarray) {
        ...
        Crypto.prototype.binb2b64 = function (binarray) {
